    ...
    await queryRunner.createTable(
      new Table({
        ...
        foreignKeys: [
          ...
          {
            name: "FK_validation_2_group_user",
          ...
          {
            name: "FK_validation_2_conjugate",
