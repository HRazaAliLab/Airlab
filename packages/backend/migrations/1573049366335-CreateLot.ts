    ...
    await queryRunner.createTable(
      new Table({
        ...
        foreignKeys: [
          ...
          {
            name: "FK_lot_requested_by_to_group_user",
            referencedTableName: "group_user",
          ...
          {
            name: "FK_lot_approved_by_to_group_user",
            referencedTableName: "group_user",
          ...
          {
            name: "FK_lot_ordered_by_to_group_user",
            referencedTableName: "group_user",
          ...
          {
            name: "FK_lot_received_by_to_group_user",
            referencedTableName: "group_user",
          ...
          {
            name: "FK_lot_finished_by_to_group_user",
            referencedTableName: "group_user",
