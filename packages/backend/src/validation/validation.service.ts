...
export class ValidationService {
  ...
  async exportValidations(groupId?: number) {
    return groupId
      ? this.repository.find({
          select: {
            ...
            notes: true,
            status: true,
            antigenRetrievalType: true,
            antigenRetrievalTime: true,
            antigenRetrievalTemperature: true,
            saponin: true,
            saponinConcentration: true,
            methanolTreatment: true,
            methanolTreatmentConcentration: true,
            surfaceStaining: true,
            surfaceStainingConcentration: true,
            meta: true,
            isArchived: true,
            createdAt: true,
            updatedAt: true,
