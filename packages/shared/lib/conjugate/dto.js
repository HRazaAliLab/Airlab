...
let CreateConjugateDto = /** @class */ (() => {
    ...
    return CreateConjugateDto;
})();
exports.CreateConjugateDto = CreateConjugateDto;
let UpdateConjugateDto = /** @class */ (() => {
    ...
    return UpdateConjugateDto;
})();
exports.UpdateConjugateDto = UpdateConjugateDto;
let UpdateConjugateStatusDto = /** @class */ (() => {
    ...
    return UpdateConjugateStatusDto;
})();
