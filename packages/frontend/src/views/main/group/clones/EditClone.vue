...
export default class EditClone extends Vue {
  ...
  reset() {
    ...
    if (this.clone) {
      ...
      if (this.clone.application && this.clone.application.hasOwnProperty(this.applicationMap.IHCF)) {
        this.ihcfApplication = this.clone.application[this.applicationMap.IHCF].toString();
      }
      if (this.clone.application && this.clone.application.hasOwnProperty(this.applicationMap.WB)) {
        this.wbApplication = this.clone.application[this.applicationMap.WB].toString();
      }
    }
  }
