<template>
  <v-container fluid>
    <v-card class="ma-4 pa-4">
      ...
      <v-card-text>
        <div class="my-6">
          <div class="subtitle-1 text--lighten-2">Name</div>
          <div class="title text--darken-2" v-if="userProfile && userProfile.name">
            {{ userProfile.name }}
          </div>
          <div class="title text--darken-2" v-else>-----</div>
        </div>
        <div class="my-4">
          <div class="subtitle-1 text--lighten-2">Email</div>
          <div class="title text--darken-2" v-if="userProfile && userProfile.email">
            {{ userProfile.email }}
          </div>
          <div class="title text--darken-2" v-else>-----</div>
        </div>
